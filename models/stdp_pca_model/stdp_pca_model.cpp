...
int main(int argc, const char** argv) {
    ...
    if (opts.NoLearning) {
        auto sim = BuildModel<
            TLayer<TSpikeSequenceNeuron, 55, TNeuronConfig<TBasicSynapse, TDeterm>>,
        ...
        auto sim = BuildModel<
            TLayer<TSpikeSequenceNeuron, 55, TNeuronConfig<TBasicSynapse, TDeterm>>,
            TLayer<TIntegrateAndFire, 1, TNeuronConfig<TBasicSynapse, TDeterm, TNoInput, TStdp, TUnitNorm>>
        >(opts);
